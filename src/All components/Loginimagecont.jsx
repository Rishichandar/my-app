                ...
                <section className="flex flex-col justify-center items-center">
                    ...
                    <div className="w-full max-w-sm bg-white p-6 rounded-lg shadow-lg h-[420px]">
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            ...
                            <p className="text-gray-800 text-center mt-[5px] text-[12px] mr-[75px] relative top-[40px]" style={{ color: 'black' }}>By clicking Login,I accept the <a href="https://posbytz.com/terms-and-conditions/" target="_blank" className="text-blue-800">Terms &amp; Conditions</a></p>
                            <button
                                type="submit"
