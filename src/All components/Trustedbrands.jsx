...
export default function Trustedbrands({brand}) {
    ...
    const contentArray = [
        {
            leftColumn: {
                title1: "Trusted by",
                title2: "Great Brands",
                description: "Over 5000+ businesses in 15 countries have registered with PosBytz.",
